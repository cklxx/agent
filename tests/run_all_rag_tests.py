...
def run_test_module(module_name: str, test_function: str):
    ...
    try:
        ...
        if module_name == "test_rag_context_manager":
            ...
            from test_workspace_rag_integration import run_workspace_rag_integration_tests
...
def main():
    ...
    for module in test_modules:
        results[module] = run_test_module(module, f"run_{module.replace('test_', '')}_tests")
