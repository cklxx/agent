            ...
            for result in results:
                ...
                if is_path_in_workspace(file_path):
                    ...
                    try:
                        ...
                        if workspace_path in abs_path.parents or abs_path == workspace_path:
...
def test_search_result_formatting():
    ...
    def format_combined_results(traditional_results: str, rag_results: list, query: str, workspace: str) -> str:
        """格式化合并搜索结果"""
        output_parts = []
    ...
    def safe_path_resolution(file_path: str, workspace: str = None) -> str:
        ...
        try:
            ...
            if os.path.isabs(file_path):
                ...
                if workspace_path in file_resolved.parents or file_resolved == workspace_path:
