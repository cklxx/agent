...
class CodeEvaluator:
    ...
    async def evaluate_code(self, task_config: Dict[str, Any], 
                           generated_code: str) -> EvaluationResult:
        """评估生成的代码"""
        ...
        try:
            ...
            # 5. 文档质量评估
            documentation_result = self._evaluate_documentation(generated_code, task_config)
    ...
    async def _evaluate_functionality(self, code: str, test_cases: List[Dict[str, Any]], 
    ...
    def _evaluate_code_quality(self, code: str, task_config: Dict[str, Any]) -> Dict[str, Any]:
        """评估代码质量"""
        result = {
            "score": 0.0,
            "syntax_score": 0.0,
    ...
    async def _evaluate_performance(self, code: str, task_config: Dict[str, Any]) -> Dict[str, Any]:
        """评估性能"""
        result = {
            "score": 0.0,
            "execution_time": 0.0,
        ...
        try:
            ...
            if execution_time <= max_time * 0.5:
                ...
                time_score = 0
                result["issues"].append(f"执行时间超出限制: {execution_time:.2f}s > {max_time}s")
    ...
    def _evaluate_security(self, code: str, task_config: Dict[str, Any]) -> Dict[str, Any]:
        """评估安全性"""
        result = {
    ...
    def _evaluate_documentation(self, code: str, task_config: Dict[str, Any]) -> Dict[str, Any]:
        """评估文档质量"""
        result = {
            "score": 0.0,
    ...
    def _extract_function_name(self, code: str, task_config: Dict[str, Any]) -> Optional[str]:
        """从代码中提取主要函数名"""
        try:
            import ast
            tree = ast.parse(code)
    ...
    def _calculate_total_score(self, dimension_scores: Dict[str, float], 
                              evaluation_criteria: Dict[str, int]) -> float:
        """计算总分"""
        total_score = 0.0
        total_weight = 0
    ...
    def generate_feedback_report(self, evaluation_result: EvaluationResult) -> str:
        ...
        report.append(f"总分: {evaluation_result.total_score:.2f}/{evaluation_result.max_score}")
        ...
        if func_feedback:
            report.append(f"功能测试: {func_feedback.get('passed_tests', 0)}/{func_feedback.get('total_tests', 0)} 通过")
        ...
        if quality_feedback:
            ...
            report.append(f"  结构分数: {quality_feedback.get('structure_score', 0):.1f}")
