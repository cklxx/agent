...
const features = [
  {
    ...
    href: "https://github.com/bytedance/agent/blob/main/src/tools",
    cta: "Learn more",
    background: (
  ...
  },
  {
    ...
    href: "https://github.com/bytedance/agent/blob/main/src/graph/nodes.py",
    cta: "Learn more",
    background: (
      <img alt="background" className="absolute -top-20 -right-20 opacity-60" />
    ),
  ...
  },
  {
    ...
    href: "https://github.com/bytedance/agent/blob/main/src/podcast",
    cta: "Learn more",
    background: (
      <img alt="background" className="absolute -top-20 -right-20 opacity-60" />
    ),
  ...
  return (
    <section className="relative flex w-full flex-col content-around items-center justify-center">
      <SectionHeader
        ...
        title="Core Features"
        description="Find out what makes DeepTool effective."
      />
