...
This is the web UI for [`DeepTool`](https://github.com/bytedance/agent).

## Quick Start

### Prerequisites

- [`DeepTool`](https://github.com/bytedance/agent)
- Node.js (v22.14.0+)
...
DeepTool Web UI uses `pnpm` as its package manager.
...
DeepTool is built upon the foundation of these outstanding projects:
