...
class FileWriter:
    ...
    def __init__(self, backup_dir: str = ".backups", max_backup_files: int = 10):
        ...
        self.forbidden_paths = {
            '/etc', '/bin', '/sbin', '/usr/bin', '/usr/sbin', '/system',
    ...
    def generate_diff(self, original_content: str, new_content: str, file_path: str = "file") -> str:
        """生成文件差异对比"""
...
@tool
def write_file(file_path: str, content: str, encoding: str = "utf-8", create_backup: bool = True) -> str:
    """
    写入文件内容
...
@tool
def generate_file_diff(file_path: str, new_content: str, encoding: str = "utf-8") -> str:
    """
    生成文件内容差异对比
