...
class FileReader:
    ...
    def is_file_readable(self, file_path: str) -> tuple[bool, str]:
        ...
        if file_size > self.max_file_size:
            return False, f"文件太大: {file_size} bytes (最大: {self.max_file_size} bytes)"
    ...
    def read_file_lines(self, file_path: str, start_line: int = 1, end_line: Optional[int] = None, encoding: str = 'utf-8') -> Dict[str, Any]:
        """
        读取文件的指定行范围
...
@tool
def read_file_lines(file_path: str, start_line: int = 1, end_line: int = None, encoding: str = "utf-8") -> str:
    """
    读取文件的指定行范围
